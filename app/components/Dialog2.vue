...
const dialogTemplateRef = useTemplateRef<HTMLDialogElement>('dialog2');
...
<template>
  <dialog
    ref="dialog2"
    :aria-labelledby="id"
    :class="`dialog2 dialog2-position--${position}`"
